...
Public Class Form1
    ...
    Private Sub Grupa2_Mouse_in(sender As Object, e As EventArgs) Handles Grupa2.MouseEnter
        Grupa2.BackColor = Color.DimGray
    End Sub
    ...
    Private Sub Grupa3_Mouse_in(sender As Object, e As EventArgs) Handles Grupa3.MouseEnter
        Grupa3.BackColor = Color.DimGray
    End Sub
    ...
    Private Sub Grupa4_Mouse_in(sender As Object, e As EventArgs) Handles Grupa4.MouseEnter
        Grupa4.BackColor = Color.DimGray
    End Sub
    ...
    Private Sub Grupa5_Mouse_in(sender As Object, e As EventArgs) Handles Grupa5.MouseEnter
        Grupa5.BackColor = Color.DimGray
    End Sub
    ...
    Private Sub Grupa6_Mouse_in(sender As Object, e As EventArgs) Handles Grupa6.MouseEnter
        Grupa6.BackColor = Color.DimGray
    End Sub
    ...
    Private Sub Grupa7_Mouse_in(sender As Object, e As EventArgs) Handles Grupa7.MouseEnter
        Grupa7.BackColor = Color.DimGray
    End Sub
    ...
    Private Sub Grupa8_Mouse_in(sender As Object, e As EventArgs) Handles Grupa8.MouseEnter
        Grupa8.BackColor = Color.DimGray
    End Sub
    ...
    Private Sub Grupa9_Mouse_in(sender As Object, e As EventArgs) Handles Grupa9.MouseEnter
        Grupa9.BackColor = Color.DimGray
    End Sub
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        'GRUPA 1
        For Each line As String In File.ReadLines("C:\Users\dan\Desktop\Treaba\facultate\Ura an1\Semestrul 1 si 2\bazele progarmarii pe obiecte\Poriect Bazele programarii pe obiecte\Data.txt")
        ...
        Next
        'GRUPA 2
        For Each line As String In File.ReadLines("C:\Users\dan\Desktop\Treaba\facultate\Ura an1\Semestrul 1 si 2\bazele progarmarii pe obiecte\Poriect Bazele programarii pe obiecte\Data.txtt")
